...
h("#toolbarDebug").css("opacity","0.4");h("#toolbarDebug").css("filter","alpha(opacity\x3d40)");h("#process").html("")}function G(){f={};g=null;t.w2ui.debug.records=[];t.w2ui.debug.refresh()}function l(){var a=[],b=1,c;for(c in f)if(f.hasOwnProperty(c)){var d=f[c];if(null!=d){var e=d.getProject();if(e==document.title||null==e){var e="\x3cdiv class\x3d'debugIdleRecord'\x3e"+c+"\x3c/div\x3e",h="\x26nbsp;\x3cinput type\x3d'radio'\x3e\x3clabel\x3e\x3c/label\x3e",p="",m=d.isDebug(),n=d.getStatus(),l=!1;
g==c&&(h="\x26nbsp;\x3cinput type\x3d'radio' checked\x3e\x3clabel\x3e\x3c/label\x3e");null!=d.getResource()&&(p=w.FileTree.createResourcePath(d.getResource()),e=g==c&&m?"\x3cdiv class\x3d'debugFocusRecord'\x3e"+c+"\x3c/div\x3e":"\x3cdiv class\x3d'debugRecord'\x3e"+c+"\x3c/div\x3e",p=p.getResourcePath(),l=!0);a.push({recid:b++,name:e,active:h,process:c,status:k[n],running:l,system:d.getSystem(),resource:d.getResource(),focus:g==c,script:p})}else console.log("Ignoring process "+c+" as it belongs to "+
e)}}u.Common.updateTableRecords(a,"debug")}var k;(function(a){a[a.REGISTERING=0]="REGISTERING";a[a.WAITING=1]="WAITING";a[a.STARTING=2]="STARTING";a[a.COMPILING=3]="COMPILING";a[a.DEBUGGING=4]="DEBUGGING";a[a.RUNNING=5]="RUNNING";a[a.TERMINATING=6]="TERMINATING";a[a.FINISHED=7]="FINISHED";a[a.UNKNOWN=8]="UNKNOWN"})(k||(k={}));var F=function(){function a(a,c,d,e,f,g,h,k,l,m,n){this._process=a;this._resource=d;this._system=e;this._time=g;this._running=h;this._focus=l;this._project=c;this._memory=m;
