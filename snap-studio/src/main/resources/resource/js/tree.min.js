...
b){e.ui.fancytree.getNode(b.target).setActive();b.menu.zIndex(e(a.target).zIndex()+2E3)},select:function(a,c){var d=e.ui.fancytree.getNode(c.target),g=w(d.tooltip);b(g,c.cmd,c.key,d.isFolder())}})}function A(a,b){var d=a.target.files||a.originalEvent.dataTransfer.files||a.dataTransfer.files;if(d)for(var c=0;c<d.length;c++){var e=d[c];if(D()){console.log("file\x3d"+e.name+" folder\x3d"+b);var g=new FileReader;g.onload=function(a){var c;c="";a=new Uint8Array(a.target.result);for(var d=a.byteLength,
g=0;g<d;g++)c+=String.fromCharCode(a[g]);c=window.btoa(c);l.Command.uploadFileTo(e.name,b,c)};g.readAsArrayBuffer(e)}}}function v(a){return(a=e(a).filter(".fancytree-folder"))?0<a.length:!1}function D(){var a=document.createElement("div");return("draggable"in a||"ondragstart"in a&&"ondrop"in a)&&"FormData"in window&&"FileReader"in window}function x(a){if(!k.Common.stringEndsWith(a,"/")){var b=a.split(".");return 1===a.length||""===b[0]&&2===b.length?!0:0<=b.pop().indexOf("/")}return!0}function n(a){if(null!=
a){for(a=a.replace(/\/+/,"/").replace(/\.#/,"");-1!=a.indexOf("//");)a=a.replace("//","/");k.Common.stringEndsWith(a,"/")&&(a=a.substring(0,a.length-1));return a}return null}function w(a){for(var b="/resource/"+document.title+"/",d="/resource/"+document.title;-1!=a.indexOf("//");)a=a.replace("//","/");if(a==d||a==b)return new q(n(b),"/","/","/",null,"/",a);0!=a.indexOf("/")&&(a="/"+a);0!=a.indexOf(b)&&(a="/resource/"+document.title+a);for(var c=x(a),b=a.split("/"),d="/resource/"+document.title,e=
"",g="",k="",h="",f=3;f<b.length;f++)d+="/"+b[f],e+="/"+b[f],k+="/"+b[f];if(c)if(c=b[b.length-1],3<b.length)for(f=3;f<b.length;f++)g+="/"+b[f],h+="/"+b[f];else h="/";else if(c=b[b.length-1],4<b.length)for(f=3;f<b.length-1;f++)g+="/"+b[f],h+="/"+b[f];else h="/";return new q(n(d),n(e),n(""==g?"/":g),n(k),n(c),n(h),a)}m.createTree=function(a,b,d,c,e,g,k){h(a,b,d,c,e,g,k,1E4)};m.createTreeOfDepth=h;m.showTreeNode=function(a,b){a&&b&&b.getResourcePath()&&(u(a,b.getResourcePath()),u(a,b.getResourcePath()))};
m.isResourceFolder=x;m.cleanResourcePath=n;m.createResourcePath=w})(h.FileTree||(h.FileTree={}))});
