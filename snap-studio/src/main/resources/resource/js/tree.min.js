...
1],3<b.length)for(f=3;f<b.length;f++)g+="/"+b[f],h+="/"+b[f];else h="/";else if(c=b[b.length-1],4<b.length)for(f=3;f<b.length-1;f++)g+="/"+b[f],h+="/"+b[f];else h="/";return new q(n(d),n(e),n(""==g?"/":g),n(k),n(c),n(h),a)}m.createTree=function(a,b,d,c,e,g,k){h(a,b,d,c,e,g,k,1E4)};m.createTreeOfDepth=h;m.showTreeNode=function(a,b){a&&b&&b.resourcePath&&(u(a,b.resourcePath),u(a,b.resourcePath))};m.isResourceFolder=x;m.cleanResourcePath=n;m.createResourcePath=w})(h.FileTree||(h.FileTree={}))});
