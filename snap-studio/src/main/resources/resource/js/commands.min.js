...
f=0;f<a.length;f++){var g=window.document.location.pathname,g=-1!==g.indexOf(";debug",g.length-6),e="/project/"+a[f].project,h="\x3ci style\x3d'opacity: 0.5'\x3e"+a[f].module+"\x3ci\x3e",k="";a[f].extra&&(k="\x3ci style\x3d'opacity: 0.5'\x3e"+a[f].extra+"\x3ci\x3e");g&&(e+=";debug");e=r(a[f].extra)?e+("#"+x(a[f].extra,a[f].module+"."+a[f].name)):e+("#"+a[f].resource);b.push([{text:a[f].name+"\x26nbsp;\x26nbsp;"+h,link:e,line:0,style:"module"==a[f].type?"moduleNode":"typeNode"},{text:a[f].resource+
"\x26nbsp;\x26nbsp;"+k,link:e,line:0,style:"resourceNode"}])}c(b,d)})},null,"Search Types")};b.searchOutline=function(){l.DialogBuilder.createListDialog(function(a,d,c){G(a,function(a,d){for(var b=[],f=0;f<a.length;f++){var e=a[f],g=e.type.toLowerCase(),h="\x3ci style\x3d'opacity: 0.5'\x3e"+e.constraint+"\x3ci\x3e",k;k=e.declaringClass;k=k.substring(k.lastIndexOf(".")+1);var l=e.declaringClass,l="\x3ci style\x3d'opacity: 0.5'\x3e"+l.substring(0,l.lastIndexOf("."))+"\x3ci\x3e",m=e.resource,p=e.line,
q=null;r(e.libraryPath)&&e.declaringClass?(q="/project/"+document.title+"#"+x(e.libraryPath,e.declaringClass),p=null):m="/resource/"+document.title+m;b.push([{text:e.name+"\x26nbsp;\x26nbsp;"+h,resource:m,link:q,line:p,style:"function"==g?"functionNode":"propertyNode"},{text:k+"\x26nbsp;\x26nbsp;"+l,resource:m,link:q,line:p,style:"resourceNode"}])}c(b,d)})},null,"Search Outline")};b.replaceTokenInFiles=function(a,d,c){z(a,c,d,function(a){for(var d=h.FileEditor.currentEditorState(),c=0;c<a.length;c++){var b=
a[c],b=k.FileTree.createResourcePath("/resource/"+b.project+"/"+b.resource);d.getResource().getResourcePath()==b.getResourcePath()&&w.FileExplorer.openTreeFile(b.getResourcePath(),function(){})}})};b.searchFiles=function(a){y(!1,a)};b.searchAndReplaceFiles=function(a){y(!0,a)};b.findFileNames=function(){l.DialogBuilder.createListDialog(function(a,d,c){H(a,function(a,d){for(var b=[],f=0;f<a.length;f++){var e=a[f],g=window.document.location.pathname,g=-1!==g.indexOf(";debug",g.length-6),h="/project/"+
e.project;g&&(h+=";debug");h+="#"+e.resource;b.push([{text:e.text,name:e.name,link:h,style:"resourceNode"}])}return c(b,d)})},null,"Find Files")};b.openTerminal=function(a){k.FileTree.isResourceFolder(a.getFilePath())&&(a={project:document.title,resource:a.getFilePath(),terminal:!0},e.EventBus.sendEvent("EXPLORE",a))};b.exploreDirectory=function(a){k.FileTree.isResourceFolder(a.getFilePath())&&(a={project:document.title,resource:a.getFilePath(),terminal:!1},e.EventBus.sendEvent("EXPLORE",a))};b.folderExpand=
