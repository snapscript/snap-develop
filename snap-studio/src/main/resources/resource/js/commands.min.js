...
l.substring(0,l.lastIndexOf("."))+"\x3ci\x3e",r=f.resource,n=f.line,p=null;q(f.libraryPath)&&f.declaringClass?(p="/project/"+document.title+"#"+x(f.libraryPath,f.declaringClass),n=null):r="/resource/"+document.title+r;b.push([{text:f.name+"\x26nbsp;\x26nbsp;"+k,resource:r,link:p,line:n,style:"function"==g?"functionNode":"propertyNode"},{text:h+"\x26nbsp;\x26nbsp;"+l,resource:r,link:p,line:n,style:"resourceNode"}])}e(b,c)})},null,"Search Outline")};b.replaceTokenInFiles=function(a,c,b){z(a,b,c,function(a){for(var c=
...
a))};b.stepInScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.getThread(),type:"STEP_IN"},g.FileEditor.clearEditorHighlights(),d.EventBus.sendEvent("STEP",a))};b.stepOutScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.getThread(),type:"STEP_OUT"},g.FileEditor.clearEditorHighlights(),d.EventBus.sendEvent("STEP",a))};b.resumeScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.getThread(),type:"RUN"},g.FileEditor.clearEditorHighlights(),
d.EventBus.sendEvent("STEP",a))};b.stopScript=function(){d.EventBus.sendEvent("STOP")};b.browseScriptVariables=function(a){var b=l.ThreadManager.focusedThread();null!=b&&(a={thread:b.getThread(),expand:a},d.EventBus.sendEvent("BROWSE",a))};b.browseScriptEvaluation=function(a,b,e){var c=l.ThreadManager.focusedThread();null!=c&&(a={thread:c.getThread(),expression:b,expand:a,refresh:e},d.EventBus.sendEvent("EVALUATE",a))};b.attachProcess=function(a){var b=D.DebugManager.currentStatusFocus(),e=g.FileEditor.currentEditorState();
a={process:a,breakpoints:e.getBreakpoints(),project:document.title,focus:b!=a};d.EventBus.sendEvent("ATTACH",a)};b.switchLayout=function(){var a=window.document.location.pathname,b=window.document.location.hash;-1!==a.indexOf(";debug",a.length-6)?(a=a.substring(0,a.length-6),document.location=a+b):document.location=a+";debug"+b};b.updateDisplay=function(a){d.EventBus.isSocketOpen()&&d.EventBus.sendEvent("DISPLAY_UPDATE",a)};b.evaluateExpression=function(){if(null!=l.ThreadManager.focusedThread()){var a=
g.FileEditor.getSelectedText();h.DialogBuilder.evaluateExpressionDialog(a)}};b.refreshScreen=function(){setTimeout(function(){location.reload()},10)};b.switchProject=function(){document.location="/"}})(q.Command||(q.Command={}))});
