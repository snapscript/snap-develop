...
d.outlines;var f=[],e;for(e in d)if(d.hasOwnProperty(e)){var c=d[e];f.push({name:e,type:c.type,resource:c.resource,line:c.line,constraint:c.constraint,declaringClass:c.declaringClass,libraryPath:c.libraryPath})}b(f,a)},error:function(d){b([],a);console.log("Could not complete outline for text '"+a+"'",e)},async:!0,processData:!1,type:"POST",url:"/outline/"+document.title})}else b([],a)}function x(a,b){b||(b="*.snap,*.properties,*.xml,*.txt,*.json");var d=k.DialogBuilder.createTextSearchOnlyDialog;
a&&(d=k.DialogBuilder.createTextSearchAndReplaceDialog);d(function(a,b,d,c){y(a,b,d,function(a,b){for(var d=[],f=0;f<a.length;f++){var e=a[f],p=window.document.location.pathname;p.indexOf(";debug",p.length-6);p="/resource/"+e.project+"/"+e.resource;d.push([{text:e.resource,line:e.line,resource:p,style:"resourceNode"},{text:e.text,line:e.line,resource:p,style:"textNode"}])}return c(d,b)})},b,a?"Replace Text":"Find Text")}function y(a,b,d,f){if(a&&1<a.length){var e;e="/find/"+document.title;e+="?expression\x3d"+
...
q.ajax({url:"/file/"+document.title+"?expression\x3d"+a,success:function(d){for(var f=[],e=0;e<d.length;e++)f.push(d[e]);b(f,a)},async:!0}):b([],a)}function z(a,b){var d=h.FileEditor.loadEditor();null==d.resource?k.DialogBuilder.openTreeDialog(null,!1,function(d){u(b);a()}):h.FileEditor.isEditorChanged()?k.DialogBuilder.openTreeDialog(d.resource,!0,function(d){u(b);a()}):(n.ProcessConsole.clearConsole(),a())}function u(a){var b=h.FileEditor.loadEditor(),d=b.resource;if(null!=d){var f={project:document.title,
resource:d.filePath,source:b.source,directory:!1,create:!1};n.ProcessConsole.clearConsole();g.EventBus.sendEvent("SAVE",f);a&&(a=(new Date).getTime(),h.FileEditor.updateEditor(b.source,d.projectPath,a))}}function A(a){z(function(){var b=h.FileEditor.loadEditor();g.EventBus.sendEvent("EXECUTE",{breakpoints:b.breakpoints,project:document.title,resource:b.resource.filePath,source:b.source,debug:a?!0:!1})},!0)}c.searchTypes=function(){k.DialogBuilder.createListDialog(function(a,b,d){E(a,function(a,b){for(var e=
[],c=0;c<a.length;c++){var f=window.document.location.pathname,f=-1!==f.indexOf(";debug",f.length-6),g="/project/"+a[c].project,h="\x3ci style\x3d'opacity: 0.5'\x3e"+a[c].module+"\x3ci\x3e",k="";a[c].extra&&(k="\x3ci style\x3d'opacity: 0.5'\x3e"+a[c].extra+"\x3ci\x3e");f&&(g+=";debug");g=r(a[c].extra)?g+("#"+w(a[c].extra,a[c].module+"."+a[c].name)):g+("#"+a[c].resource);e.push([{text:a[c].name+"\x26nbsp;\x26nbsp;"+h,link:g,style:"module"==a[c].type?"moduleNode":"typeNode"},{text:a[c].resource+"\x26nbsp;\x26nbsp;"+
k,link:g,style:"resourceNode"}])}d(e,b)})},null,"Search Types")};c.searchOutline=function(){k.DialogBuilder.createListDialog(function(a,b,d){F(a,function(a,b){for(var c=[],e=0;e<a.length;e++){var f=a[e],g=f.type.toLowerCase(),h="\x3ci style\x3d'opacity: 0.5'\x3e"+f.constraint+"\x3ci\x3e",k;k=f.declaringClass;k=k.substring(k.lastIndexOf(".")+1);var l=f.declaringClass,l="\x3ci style\x3d'opacity: 0.5'\x3e"+l.substring(0,l.lastIndexOf("."))+"\x3ci\x3e",m=f.resource,n=f.line,q=null;r(f.libraryPath)&&f.declaringClass?
(q="/project/"+document.title+"#"+w(f.libraryPath,f.declaringClass),n=null):m="/resource/"+document.title+m;c.push([{text:f.name+"\x26nbsp;\x26nbsp;"+h,resource:m,link:q,line:n,style:"function"==g?"functionNode":"propertyNode"},{text:k+"\x26nbsp;\x26nbsp;"+l,resource:m,link:q,line:n,style:"resourceNode"}])}d(c,b)})},null,"Search Outline")};c.replaceTokenInFiles=function(a,b,d){y(a,d,b,function(a){for(var b=h.FileEditor.loadEditor(),d=0;d<a.length;d++){var c=a[d],c=l.FileTree.createResourcePath("/resource/"+
c.project+"/"+c.resource);b.resource.resourcePath==c.resourcePath&&C.FileExplorer.openTreeFile(c.resourcePath,function(){})}})};c.searchFiles=function(a){x(!1,a)};c.searchAndReplaceFiles=function(a){x(!0,a)};c.findFileNames=function(){k.DialogBuilder.createListDialog(function(a,b,d){G(a,function(a,b){for(var c=[],e=0;e<a.length;e++){var f=a[e],g=window.document.location.pathname,g=-1!==g.indexOf(";debug",g.length-6),h="/project/"+f.project;g&&(h+=";debug");h+="#"+f.resource;c.push([{text:f.text,name:f.name,
link:h,style:"resourceNode"}])}return d(c,b)})},null,"Find Files")};c.openTerminal=function(a){l.FileTree.isResourceFolder(a.filePath)&&g.EventBus.sendEvent("EXPLORE",{project:document.title,resource:a.filePath,terminal:!0})};c.exploreDirectory=function(a){l.FileTree.isResourceFolder(a.filePath)&&g.EventBus.sendEvent("EXPLORE",{project:document.title,resource:a.filePath,terminal:!1})};c.folderExpand=function(a){g.EventBus.sendEvent("FOLDER_EXPAND",{project:document.title,folder:a})};c.folderCollapse=
