define(["require","exports","jquery"],function(t,m,q){(function(b){function m(a,e){var c;if(e&&0<e.length){var d=e[0].field,l=e[0].direction;c=[];for(var f={},b=0;b<a.length;b++){var k=a[b];if(k){var g=k[d].toLowerCase(),h=f[g];null==h&&(h=[],f[g]=h);h.push(k)}}d=[];for(g in f)f.hasOwnProperty(g)&&d.push(g);d.sort();"asc"!=l&&d.reverse();for(b=0;b<d.length;b++)for(g=d[b],h=f[g],l=0;l<h.length;l++)k=h[l],c.push(k)}else c=a;return c}function r(){return(new Date).getTime()}b.openDialog=function(a,e,
