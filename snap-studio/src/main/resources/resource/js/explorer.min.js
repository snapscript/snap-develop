...
"text"))?window.location.href=g:(p.FileEditor.resolveEditorMode(a),p.FileEditor.updateEditor(b,a));c()}function q(a){return e.Common.stringEndsWith(a,".json")||e.Common.stringEndsWith(a,".js")||e.Common.stringEndsWith(a,".xml")||e.Common.stringEndsWith(a,".project")||e.Common.stringEndsWith(a,".classpath")||e.Common.stringEndsWith(a,".index")}function u(a,c,g,d){"runScript"==c?k(a.resourcePath,function(){b.Command.runScript()}):"debugScript"==c?k(a.resourcePath,function(){b.Command.debugScript()}):
