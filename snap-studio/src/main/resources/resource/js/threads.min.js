...
(e=h.UNKNOWN,console.warn("No such thread status "+b+" setting to "+h[e]));a=new q(t,I,e,a.instruction,a.process,a.resource,a.source,a.thread,a.stack,a.line,a.depth,a.key);b=c&&c.getThread()==a.getThread()?a.getStatus()!=h.SUSPENDED:!1;if(b)p(),m(a),d.FileEditor.clearEditorHighlights();else if(c.getThread()==a.getThread()){a:{if(c&&c.getThread()==a.getThread()&&a.getStatus()==h.SUSPENDED){if(c.getKey()!=a.getKey()){b=!0;break a}if(c.isChange()!=a.isChange()){b=!0;break a}}b=!1}b&&(c&&c.getThread()==
a.getThread()&&c.getLine()!=a.getLine()?c&&c.getThread()==a.getThread()&&d.FileEditor.currentEditorState().getResource().getFilePath()!=a.getResource()?A(a):(k(a),d.FileEditor.showEditorLine(a.getLine())):k(a),m(a))}else null==c.getThread()?((b=d.FileEditor.currentEditorState())&&b.getResource()&&b.getResource().getFilePath()==a.getResource()?(k(a),d.FileEditor.showEditorLine(a.getLine())):A(a),m(a)):(b=f[a.getThread()],(null!=b&&null!=a?b.getThread()!=a.getThread()||b.getStatus()!=a.getStatus()||
b.getResource()!=a.getResource()||b.getLine()!=a.getLine():b!=a)&&m(a));f[a.getThread()]=a;z(a)}function z(a){var b=d.FileEditor.currentEditorState();c.getThread()==a.getThread()&&b.getResource().getFilePath()==a.getResource()&&a.getStatus()==h.SUSPENDED&&(d.FileEditor.createEditorHighlight(a.getLine(),"threadHighlight"),d.FileEditor.showEditorLine(a.getLine()))}function m(a){f[a.getThread()]=a;B();l.VariableManager.showVariables()}function A(a){var b=v.FileTree.createResourcePath(a.getResource()),
c=a.getSource();c?w.FileExplorer.showAsTreeFile(b.getResourcePath(),c,function(){k(a);d.FileEditor.showEditorLine(a.getLine())}):w.FileExplorer.openTreeFile(b.getResourcePath(),function(){k(a);d.FileEditor.showEditorLine(a.getLine())})}function p(){l.VariableManager.clearVariables();c=new q(new g({}),new g({}),h.RUNNING,null,null,null,null,null,null,-1,-1,-1)}function k(a){c=a=new q(a.getVariables(),a.getEvaluation(),a.getStatus(),a.getInstruction(),a.getProcess(),a.getResource(),a.getSource(),a.getThread(),
a.getStack(),a.getLine(),a.getDepth(),a.getKey());m(a)}function B(){var a=[],b=1,e;for(e in f)if(f.hasOwnProperty(e)){var d=f[e],g="threadSuspended",k="\x26nbsp;\x3cinput type\x3d'radio'\x3e";z(d);d.getStatus()!=h.SUSPENDED?g="threadRunning":c.getThread()==d.getThread()&&(k="\x26nbsp;\x3cinput type\x3d'radio' checked\x3e");var g="\x3cdiv title\x3d'"+d.getStack()+"' class\x3d'"+g+"'\x3e"+e+"\x3c/div\x3e",l=v.FileTree.createResourcePath(d.getResource());a.push({recid:b++,name:g,thread:e,status:h[d.getStatus()],
active:k,instruction:d.getInstruction(),variables:d.getVariables(),resource:d.getResource(),key:d.getKey(),line:d.getLine(),script:l.getResourcePath()})}D.Common.updateTableRecords(a,"threads")}var f={},c=null;b.createThreads=function(){n.EventBus.createRoute("BEGIN",e,r);n.EventBus.createRoute("SCOPE",H,l.VariableManager.clearVariables);n.EventBus.createRoute("TERMINATE",x);n.EventBus.createRoute("EXIT",x)};b.terminateThreads=y;b.clearThreads=r;b.focusedThread=function(){return c&&null!=c.getThread()?
