...
function(){var a=b.editorPanel.getSession();p();b.editorResource=null;b.editorPanel.setReadOnly(!1);a.setValue(b.editorText,1);u("#currentFile").html("")};e.loadEditor=w;e.resolveEditorMode=v;e.updateEditor=function(a,d){var c=b.editorPanel.getSession(),k=c.getMode(),t=v(d);a:{var f=a;if(f){var l=d.toLowerCase();if(h.Common.stringEndsWith(l,".json"))try{var n=JSON.parse(f);a=JSON.stringify(n,null,3);break a}catch(P){}a=f}else a=""}f=w();f.resource&&f.source&&(l=E.md5(f.source),b.editorHistory[f.resource.resourcePath]=
...
b.editorTheme=a)};e.updateEditorFont=function(a,d){var c=J();b.editorPanel.completers=[c];b.editorPanel.setOptions({enableBasicAutocompletion:!0,fontFamily:"'"+a+"',monospace",fontSize:d})}})(v=m.FileEditor||(m.FileEditor={}))});
