...
R.StatusPanel.showActiveFile(b.editorResource.projectPath);e.showEditorFileInTree();M();G(b.editorResource.resourcePath)};e.showEditorFileInTree=function(){var a=z().resource;y.FileTree.showTreeNode("explorerTree",a)};e.getSelectedText=function(){return b.editorPanel.getSelectedText()};e.isEditorChanged=F;e.isEditorChangedForPath=L;e.scrollEditorToPosition=M;e.updateProjectTabOnChange=function(){b.editorPanel.on("input",function(){G(b.editorResource.resourcePath)})};e.formatEditorSource=function(){var a=
b.editorPanel.getValue();x.ajax({contentType:"text/plain",data:a,success:function(a){b.editorPanel.setReadOnly(!1);b.editorPanel.setValue(a,1)},error:function(){console.log("Format failed")},processData:!1,type:"POST",url:"/format/"+document.title})};e.setEditorTheme=function(a){null!=a&&(null!=b.editorPanel&&b.editorPanel.setTheme(a),b.editorTheme=a)};e.updateEditorFont=function(a,d){var c=N();b.editorPanel.completers=[c];b.editorPanel.setOptions({enableBasicAutocompletion:!0,fontFamily:"'"+a+"',monospace",
fontSize:d})}})(n=l.FileEditor||(l.FileEditor={}))});
