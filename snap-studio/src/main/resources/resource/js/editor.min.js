...
r,f,e,l){r=a.getValue();var c=a.session.getLine(f.row);a=d.getEditorResource().getProjectPath();c=c.substring(0,f.column);f=JSON.stringify({resource:a,line:f.row+1,complete:c,source:r,prefix:e});v.ajax({contentType:"application/json",data:f,dataType:"json",success:function(a){var c=a.expression;if(c){var d=Math.max(0,c.lastIndexOf(".")+1);a=a.tokens;var r=[],e;for(e in a)if(a.hasOwnProperty(e)){var f=a[e];b.Common.stringStartsWith(e,c)&&(e=e.substring(d));r.push({className:"autocomplete_"+f,token:e,
value:e,score:300,meta:f})}l(null,r)}},error:function(){console.log("Completion control failed")},processData:!1,type:"POST",url:"/complete/"+document.title})}}}function B(){var a=x.ace.edit("editor"),b=R();a.completers=[b];a.getSession().setMode("ace/mode/snapscript");a.getSession().setTabSize(3);a.setReadOnly(!1);a.setAutoScrollEditorIntoView(!0);a.getSession().setUseSoftTabs(!0);a.commands.removeCommand("replace");a.commands.removeCommand("find");a.commands.removeCommand("expandToMatching");a.commands.removeCommand("expandtoline");
