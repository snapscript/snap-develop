...
".policy"))return"ace/mode/policy";if(b.Common.stringEndsWith(c,".xml"))return"ace/mode/xml";if(b.Common.stringEndsWith(c,".json"))return"ace/mode/json";if(b.Common.stringEndsWith(c,".sql"))return"ace/mode/sql";if(b.Common.stringEndsWith(c,".pl"))return"ace/mode/perl";if(b.Common.stringEndsWith(c,".kt"))return"ace/mode/kotlin";if(b.Common.stringEndsWith(c,".js"))return"ace/mode/javascript";if(b.Common.stringEndsWith(c,".ts"))return"ace/mode/typescript";if(b.Common.stringEndsWith(c,".java"))return"ace/mode/java";
if(b.Common.stringEndsWith(c,".groovy"))return"ace/mode/groovy";if(b.Common.stringEndsWith(c,".py"))return"ace/mode/python";if(b.Common.stringEndsWith(c,".html")||b.Common.stringEndsWith(c,".htm"))return"ace/mode/html";if(b.Common.stringEndsWith(c,".txt"))return"ace/mode/text";if(b.Common.stringEndsWith(c,".properties"))return"ace/mode/properties";if(b.Common.stringEndsWith(c,".gitignore"))return"ace/mode/text";if(b.Common.stringEndsWith(c,".project"))return"ace/mode/xml";b.Common.stringEndsWith(c,
".classpath");return"ace/mode/text"}function q(){if(d.getEditorResource()){var c=d.getEditorResource().getResourcePath();return u(c)}return null}function u(c){c=w.FileTree.createResourcePath(c);var a=d.getHistoryForResource(c),b=a.getLastModified();return M(c.getResourcePath())?(a=d.getEditorPanel().getValue(),new F(b,c,a,!0)):new F(b,c,a.getSavedText(),!1)}function z(c){d.getEditorPanel().setReadOnly(c)}function N(){return d.getEditorPanel().getSelectionRange().start.row}function O(){if(null!=d.getEditorResource()){var c=
d.getHistoryForResource(d.getEditorResource()),a=d.getEditorPanel().getValue(),c=c.getOriginalText();return a!=c}return!1}function P(a){if(M(a))return O();a=w.FileTree.createResourcePath(a);var c=d.getHistoryForResource(a);a=c.getOriginalText();c=c.getSavedText();return a!=c}function M(a){return null!=d.getEditorResource()&&d.getEditorResource().getResourcePath()==a?!0:!1}function Q(){var a=d.getEditorPanel().getSession();d.getHistoryForResource(d.getEditorResource()).restoreScrollPosition(a,d.getEditorPanel())}
function H(a){A.Project.markEditorTab(a,P(a))}function R(){return{getCompletions:function(a,r,f,e,l){r=a.getValue();var c=a.session.getLine(f.row);a=d.getEditorResource().getProjectPath();c=c.substring(0,f.column);f=JSON.stringify({resource:a,line:f.row+1,complete:c,source:r,prefix:e});v.ajax({contentType:"application/json",data:f,dataType:"json",success:function(a){var c=a.expression;if(c){var d=Math.max(0,c.lastIndexOf(".")+1);a=a.tokens;var r=[],e;for(e in a)if(a.hasOwnProperty(e)){var f=a[e];
b.Common.stringStartsWith(e,c)&&(e=e.substring(d));r.push({className:"autocomplete_"+f,token:e,value:e,score:300,meta:f})}l(null,r)}},error:function(){console.log("Completion control failed")},processData:!1,type:"POST",url:"/complete/"+document.title})}}}function B(){var a=x.ace.edit("editor"),b=R();a.completers=[b];a.getSession().setMode("ace/mode/snapscript");a.getSession().setTabSize(3);a.setReadOnly(!1);a.setAutoScrollEditorIntoView(!0);a.getSession().setUseSoftTabs(!0);a.commands.removeCommand("replace");
a.commands.removeCommand("find");a.commands.removeCommand("expandToMatching");a.commands.removeCommand("expandtoline");a.setShowPrintMargin(!1);a.setOptions({enableBasicAutocompletion:!0});a.on("guttermousedown",function(c){var b=c.domEvent.target;if(-1!=b.className.indexOf("ace_gutter-cell")&&a.isFocused()&&!(c.clientX>25+b.getBoundingClientRect().left)){var e=c.getDocumentPosition().row,b=d.getEditorBreakpoints();if(null!=d.getEditorResource()){var r=d.getEditorPanel().getSession(),f=b[d.getEditorResource().getFilePath()],
m=r.getBreakpoints(),h=!1,n;for(n in m)if(n==e){h=!0;break}h?r.clearBreakpoint(e):r.setBreakpoint(e);n=parseInt(e);null==f?(f={},f[n+1]=!0,b[d.getEditorResource().getFilePath()]=f):f[n+1]=1==f[n+1]?!1:!0}k();c.stop()}});"undefined"!==typeof java&&a.setScrollSpeed(.05);return new J(a)}var d=null;a.createEditor=function(){d=B();d.activateEditor();S.EventBus.createTermination(e)};a.clearEditorHighlights=e;a.showEditorLine=function(a){d.getEditorPanel();d.getEditorPanel().resize(!0);if(1<a){var c=a-1;
N()!=c&&(d.getEditorPanel().scrollToLine(c,!0,!0,function(){}),d.getEditorPanel().gotoLine(a),d.getEditorPanel().focus())}else d.getEditorPanel().scrollToLine(0,!0,!0,function(){}),d.getEditorPanel().focus()};a.createEditorHighlight=function(a,b){var c=x.ace.require("ace/range").Range,r=d.getEditorPanel().getSession(),l=d.getEditorMarkers(),g=l[a];e();c=r.addMarker(new c(a-1,0,a-1,1),b,"fullLine");c=new D(a,b,c);l[a]=c;return g?g.getStyle()!=b:!1};a.createMultipleEditorHighlights=function(a,b){for(var c=
x.ace.require("ace/range").Range,r=d.getEditorPanel().getSession(),l=d.getEditorMarkers(),g=!1,h=0;h<a.length;h++){var m=a[h];(m=l[m])?m.getStyle()!=b&&(g=!0):g=!0}e();for(h=0;h<a.length;h++){var m=a[h],k=r.addMarker(new c(m-1,0,m-1,1),b,"fullLine"),k=new D(m,b,k);l[m]=k}return g};a.findAndReplaceTextInEditor=function(){var a=h().getResource();C.Command.searchAndReplaceFiles(a.getProjectPath())};a.findTextInEditor=function(){var a=h().getResource();C.Command.searchFiles(a.getProjectPath())};a.addEditorKeyBinding=
function(a,b){d.getEditorPanel().commands.addCommand({name:a.editor,bindKey:{win:a.editor,mac:a.editor},exec:function(a){b&&b()}})};a.showEditorBreakpoints=k;a.resizeEditor=function(){var a=document.getElementById("editor").offsetWidth,b=document.getElementById("editor").offsetHeight;console.log("Resize editor "+a+"x"+b);d.getEditorPanel().setAutoScrollEditorIntoView(!0);d.getEditorPanel().resize(!0)};a.currentEditorState=h;a.resolveEditorMode=y;a.clearSavedEditorBuffer=function(a){var c=w.FileTree.createResourcePath(a);
d.getHistoryForResource(c).invalidateHistory();H(a)};a.currrentEditorBuffer=q;a.getEditorBufferForResource=u;a.updateEditor=function(c){var b=c.getResourcePath(),f=c.isHistorical()||c.isError(),t=c.getFileContent(),l;l=c.getFileContent();var g=c.isHistorical()||c.isError();console.log("resource\x3d["+c.getResourcePath().getResourcePath()+"] modified\x3d["+c.getTimeStamp()+"] length\x3d["+c.getFileLength()+"] readonly\x3d["+g+"]");g?console.log("IGNORE HISTORY WHEN READ ONLY"):(g=u(c.getResourcePath().getResourcePath()),
g.getSource()&&g.getLastModified()>c.getLastModified()?(console.log("LOAD FROM HISTORY diff\x3d["+(g.getLastModified()-c.getLastModified())+"]"),l=g.getSource()):console.log("IGNORE HISTORY: ",g));c=d.getEditorPanel().getSession();var g=c.getMode(),p=y(b.getResourcePath()),m=h();if(!m.isReadOnly()){var q=m.getResource(),q=d.getHistoryForResource(q);m.isStateValid()?q.saveHistory(m):q.invalidateHistory()}p!=g&&c.setMode({path:p,v:Date.now()});f?(t=l,d.getEditorPanel().setReadOnly(!1),d.getEditorPanel().setValue(t,
1)):(g=d.getHistoryForResource(b),d.getEditorPanel().setReadOnly(!1),d.getEditorPanel().setValue(l,1),g.updateHistory(l,t),g.restoreUndoManager(c,l));var t=d.getEditorPanel().getSession(),n;for(n in t.$backMarkers)t.removeMarker(n);e();n=t.getBreakpoints();for(var w in n)t.clearBreakpoint(w);v("#currentFile").html("");z(f);d.updateResourcePath(b,f);T.ProblemManager.highlightProblems();if(null!=b&&d.getEditorResource()&&(b=d.getEditorResource().getFilePath(),b=d.getEditorBreakpoints()[b],null!=b))for(var x in b)b.hasOwnProperty(x)&&
1==b[x]&&(t=parseInt(x)-1,f=d.getEditorBreakpoints(),null!=d.getEditorResource()&&(w=d.getEditorPanel().getSession(),n=f[d.getEditorResource().getFilePath()],t=parseInt(t),w.setBreakpoint(t),null==n&&(n={},f[d.getEditorResource().getFilePath()]=n),n[t+1]=!0),k());A.Project.createEditorTab();U.History.showFileHistory();V.StatusPanel.showActiveFile(d.getEditorResource().getProjectPath());a.showEditorFileInTree();Q();H(d.getEditorResource().getResourcePath())};a.focusEditor=function(){d.getEditorPanel().focus()};
a.setReadOnly=z;a.showEditorFileInTree=function(){var a=h().getResource();w.FileTree.showTreeNode("explorerTree",a)};a.getCurrentLineForEditor=N;a.getSelectedText=function(){return d.getEditorPanel().getSelectedText()};a.isEditorChanged=O;a.isEditorChangedForPath=P;a.scrollEditorToPosition=Q;a.updateProjectTabOnChange=function(){d.getEditorPanel().on("input",function(){var a=d.getEditorResource(),a=d.getHistoryForResource(a),b=d.getEditorPanel().getValue();a.touchHistory(b);H(d.getEditorResource().getResourcePath())})};
a.formatEditorSource=function(){var a=d.getEditorPanel().getValue(),b=d.getEditorResource().getFilePath();v.ajax({contentType:"text/plain",data:a,success:function(a){d.getEditorPanel().setReadOnly(!1);d.getEditorPanel().setValue(a,1)},error:function(){console.log("Format failed")},processData:!1,type:"POST",url:"/format/"+document.title+b})};a.setEditorTheme=function(a){null!=a&&null!=d.getEditorPanel()&&d.getEditorPanel().setTheme(a)};a.updateEditorFont=function(a,b){var c=R();d.getEditorPanel().completers=
[c];d.getEditorPanel().setOptions({enableBasicAutocompletion:!0,fontFamily:"'"+a+"',monospace",fontSize:b})}})(y=e.FileEditor||(e.FileEditor={}))});
