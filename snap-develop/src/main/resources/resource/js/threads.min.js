define("require exports jquery w2ui socket common tree editor variables explorer profiler status".split(" "),function(H,m,z,t,n,A,r,e,k,u,B,C){(function(d){function m(a,b,c){a=JSON.parse(c);f={};p();k.VariableManager.clearVariables();B.Profiler.clearProfiler();q();C.StatusPanel.showProcessStatus(a.resource,a.process)}function v(a,b,e){null!=c&&c.process==e&&w()}function w(){f={};p();e.FileEditor.clearEditorHighlights();k.VariableManager.clearVariables();q()}function q(){p();t.w2ui.threads.records=
