...
resource:g,percentage:h,duration:b.time,line:b.line,count:b.count,average:l.toFixed(5),script:d.resourcePath})}w2ui.profiler.records=k;w2ui.profiler.refresh()}function g(){w2ui.profiler.records=[];w2ui.profiler.refresh()}e.startProfiler=function(){EventBus.createRoute("PROFILE",h,g)};e.clearProfiler=g})(Profiler||(Profiler={}));ModuleSystem.registerModule("profiler","Profiler module: profiler.js",null,Profiler.startProfiler,["common","socket"]);
