...
function expandVariableTree(a,f){var c=ThreadManager.focusedThread(),h=a+".*",g=a+".";if(null!=c){var d=f[c.thread];null==d&&(d=[],f[c.thread]=d);for(var c=[],b=0;b<d.length;b++){var k=d[b];k.startsWith(g)&&c.push(k)}for(b=0;b<c.length;b++)g=d.indexOf(c[b]),-1!=g&&d.splice(g,1);0==c.length&&d.push(h);return d}return null}
