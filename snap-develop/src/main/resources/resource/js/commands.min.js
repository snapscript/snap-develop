define("require exports jquery project alert socket console editor tree threads dialog explorer debug".split(" "),function(B,n,p,q,x,e,m,g,k,l,h,y,z){(function(b){function n(a,c){a?p.ajax({url:"/type/"+document.title+"?expression\x3d"+a,success:function(a){var d=[],f;for(f in a)a.hasOwnProperty(f)&&d.push(f);d.sort();for(var b=[],e=0;e<d.length;e++)f=d[e],f=a[f],b.push({name:f.name,resource:f.resource,type:f.type,project:document.title});c(b)},async:!0}):c([])}function t(a,c){c||(c="*.snap,*.properties,*.xml,*.txt,*.json");
...
"/"+b.resource);c.resource.resourcePath==b.resourcePath&&y.FileExplorer.openTreeFile(b.resourcePath,function(){})}})};b.searchFiles=function(a){t(!1,a)};b.searchAndReplaceFiles=function(a){t(!0,a)};b.findFileNames=function(){h.DialogBuilder.createListDialog(function(a,c,d){A(a,function(a){for(var c=[],b=0;b<a.length;b++){var e=a[b],g=window.document.location.pathname,g=-1!==g.indexOf(";debug",g.length-6),h="/project/"+e.project;g&&(h+=";debug");h+="#"+e.resource;c.push([{text:e.text,link:h,style:"resourceNode"}])}return d(c)})},
null,"Find Files")};b.exploreDirectory=function(a){k.FileTree.isResourceFolder(a.filePath)&&e.EventBus.sendEvent("EXPLORE",{project:document.title,resource:a.filePath})};b.folderExpand=function(a){e.EventBus.sendEvent("FOLDER_EXPAND",{project:document.title,folder:a})};b.folderCollapse=function(a){e.EventBus.sendEvent("FOLDER_COLLAPSE",{project:document.title,folder:a})};b.pingProcess=function(){e.EventBus.isSocketOpen()&&e.EventBus.sendEvent("PING",document.title)};b.isDragAndDropFilePossible=function(a,
c){return c.folder};b.dragAndDropFile=function(a,c){if(c.folder){var b=k.FileTree.createResourcePath(a.name),g=k.FileTree.createResourcePath(c.name),f=k.FileTree.cleanResourcePath(b.filePath),b=k.FileTree.cleanResourcePath(g.filePath+"/"+b.fileName);console.log("source: "+f+" destination: "+b);e.EventBus.sendEvent("RENAME",{project:document.title,from:f,to:b,dragAndDrop:!0});q.Project.renameEditorTab(f,b)}};b.renameFile=function(a){var c=a.filePath;h.DialogBuilder.renameFileTreeDialog(a,!0,function(b){e.EventBus.sendEvent("RENAME",
{project:document.title,from:c,to:b.filePath,dragAndDrop:!1});q.Project.renameEditorTab(a.resourcePath,b.resourcePath)})};b.renameDirectory=function(a){var c=a.filePath;a=k.FileTree.createResourcePath(c+".#");h.DialogBuilder.renameDirectoryTreeDialog(a,!0,function(a){e.EventBus.sendEvent("RENAME",{project:document.title,from:c,to:a.filePath})})};b.newFile=function(a){h.DialogBuilder.newFileTreeDialog(a,!0,function(a){if(!k.FileTree.isResourceFolder(a.filePath)){var b={project:document.title,resource:a.filePath,
source:"",directory:!1,create:!0};m.ProcessConsole.clearConsole();e.EventBus.sendEvent("SAVE",b);g.FileEditor.updateEditor("",a.projectPath)}})};b.newDirectory=function(a){h.DialogBuilder.newDirectoryTreeDialog(a,!0,function(a){k.FileTree.isResourceFolder(a.filePath)&&(a={project:document.title,resource:a.filePath,source:"",directory:!0,create:!0},m.ProcessConsole.clearConsole(),e.EventBus.sendEvent("SAVE",a))})};b.saveFile=function(){v(function(){},!0)};b.saveEditor=r;b.deleteFile=function(a){var b=
g.FileEditor.loadEditor();null==a&&null!=b.resource&&(a=b.resource);null!=a&&(b=g.FileEditor.loadEditor(),x.Alerts.createConfirmAlert("Delete File","Delete resource "+b.resource.filePath,"Delete","Cancel",function(){var c={project:document.title,resource:a.filePath};m.ProcessConsole.clearConsole();e.EventBus.sendEvent("DELETE",c);null!=b.resource&&b.resource.resourcePath==a.resourcePath&&g.FileEditor.resetEditor();q.Project.deleteEditorTab(a.resourcePath)},function(){}))};b.deleteDirectory=function(a){null!=
a&&(a={project:document.title,resource:a.filePath},m.ProcessConsole.clearConsole(),e.EventBus.sendEvent("DELETE",a))};b.runScript=function(){w(!1)};b.debugScript=function(){w(!0)};b.updateScriptBreakpoints=function(){var a={breakpoints:g.FileEditor.loadEditor().breakpoints,project:document.title};e.EventBus.sendEvent("BREAKPOINTS",a)};b.stepOverScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.thread,type:"STEP_OVER"},g.FileEditor.clearEditorHighlights(),e.EventBus.sendEvent("STEP",
a))};b.stepInScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.thread,type:"STEP_IN"},g.FileEditor.clearEditorHighlights(),e.EventBus.sendEvent("STEP",a))};b.stepOutScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.thread,type:"STEP_OUT"},g.FileEditor.clearEditorHighlights(),e.EventBus.sendEvent("STEP",a))};b.resumeScript=function(){var a=l.ThreadManager.focusedThread();null!=a&&(a={thread:a.thread,type:"RUN"},g.FileEditor.clearEditorHighlights(),
