define(["require","exports","jquery","common","commands"],function(x,m,g,p,f){(function(h){function m(a,b,e,c,n,u,v,k){g(document).ready(function(){var d="/tree"+a+"?id\x3d"+e+"\x26folders\x3d"+n+"\x26depth\x3d"+k;null!=c&&(d+="\x26expand\x3d"+c);g.ajax({url:d,success:function(a){g("#"+b).html(a);w(e,!n,u,v)},async:!0})})}function q(a,b){var e=document.getElementById("browseParent"),c=g("#"+a).fancytree("getTree");c&&"function"===typeof c.getNodeByKey&&(c=c.getNodeByKey(b))&&(c.li&&e&&(e.scrollTop=
0,e.scrollTop=p.Common.calculateScrollOffset(e,c.li)),c.setActive())}function w(a,b,e,c){var n={autoExpandMS:400,focusOnClick:!0,preventVoidMoves:!0,preventRecursiveMoves:!0,dragStart:function(a,b){return!0},dragEnter:function(a,b){return"undefined"!==typeof f.Command?f.Command.isDragAndDropFilePossible({name:b.otherNode.key,folder:1==b.otherNode.folder},{name:a.key,folder:1==a.folder}):!1},dragDrop:function(a,b){"undefined"!==typeof f.Command&&f.Command.dragAndDropFile({name:b.otherNode.key,folder:1==
b.otherNode.folder},{name:a.key,folder:1==a.folder})}};g("#"+a).fancytree({extensions:b?["dnd"]:[],click:c,expand:function(a,b){"undefined"!==typeof f.Command&&f.Command.folderExpand(b.node.key)},collapse:function(a,b){"undefined"!==typeof f.Command&&f.Command.folderCollapse(b.node.key)},dnd:b?n:null});null!=e&&g("#"+a).contextmenu({delegate:"span.fancytree-title",menu:[{title:"\x26nbsp;New",uiIcon:"menu-new",children:[{title:"\x26nbsp;File",cmd:"newFile",uiIcon:"menu-new"},{title:"\x26nbsp;Directory",
...
g.ui.fancytree.getNode(b.target),d=r(c.tooltip);e(d,b.cmd,b.key,c.isFolder())}})}function t(a){if(!p.Common.stringEndsWith(a,"/")){var b=a.split(".");return 1===a.length||""===b[0]&&2===b.length?!0:0<=b.pop().indexOf("/")}return!0}function l(a){if(null!=a){for(a=a.replace(/\/+/,"/").replace(/\.#/,"");-1!=a.indexOf("//");)a=a.replace("//","/");p.Common.stringEndsWith(a,"/")&&(a=a.substring(0,a.length-1));return a}return null}function r(a){for(var b="/resource/"+document.title+"/",e="/resource/"+document.title;-1!=
