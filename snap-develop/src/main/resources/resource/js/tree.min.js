...
b.menu.zIndex($(a.target).zIndex()+2E3)},select:function(a,b){var f=$.ui.fancytree.getNode(b.target),e=p(f.tooltip);c(e,b.cmd,b.key,f.isFolder())}})}function q(a){if(!a.endsWith("/")){var c=a.split(".");return 1===a.length||""===c[0]&&2===c.length?!0:0<=c.pop().indexOf("/")}return!0}function e(a){if(null!=a){for(a=a.replace(/\/+/,"/").replace(/\.#/,"");-1!=a.indexOf("//");)a=a.replace("//","/");a.endsWith("/")&&(a=a.substring(0,a.length-1));return a}return null}function p(a){for(var c="/resource/"+
document.title+"/",b="/resource/"+document.title;-1!=a.indexOf("//");)a=a.replace("//","/");if(a==b||a==c)return a={resourcePath:c,projectPath:"/",projectDirectory:"/",filePath:"/",fileName:null,fileDirectory:"/",originalPath:a},JSON.stringify(a),a;0==!a.indexOf("/")&&(a="/"+a);0==!a.indexOf(c)&&(a="/resource/"+document.title+a);for(var c=q(a),b=a.split("/"),l="/resource/"+document.title,m="",f="",k=null,g="",h="",d=3;d<b.length;d++)l+="/"+b[d],m+="/"+b[d],g+="/"+b[d];if(c)if(3<b.length)for(d=3;d<
b.length;d++)f+="/"+b[d],h+="/"+b[d];else h="/";else if(k=b[b.length-1],4<b.length)for(d=3;d<b.length-1;d++)f+="/"+b[d],h+="/"+b[d];else h="/";a={resourcePath:e(l),projectPath:e(m),projectDirectory:e(""==f?"/":f),filePath:e(g),fileName:e(k),fileDirectory:e(h),originalPath:a};JSON.stringify(a);return a}g.createTree=function(a,c,b,e,g,f,k){n(a,c,b,e,g,f,k,1E4)};g.createTreeOfDepth=n;g.isResourceFolder=q;g.cleanResourcePath=e;g.createResourcePath=p})(FileTree||(FileTree={}));
