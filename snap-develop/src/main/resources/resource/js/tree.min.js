...
originalPath:a},JSON.stringify(a),a;0==!a.indexOf("/")&&(a="/"+a);0==!a.indexOf(d)&&(a="/resource/"+document.title+a);for(var d=p(a),b=a.split("/"),e="/resource/"+document.title,m="",g="",k=null,l="",h="",c=3;c<b.length;c++)e+="/"+b[c],m+="/"+b[c],l+="/"+b[c];if(d)if(3<b.length)for(c=3;c<b.length;c++)g+="/"+b[c],h+="/"+b[c];else h="/";else if(k=b[b.length-1],4<b.length)for(c=3;c<b.length-1;c++)g+="/"+b[c],h+="/"+b[c];else h="/";a={resourcePath:f(e),projectPath:f(m),projectDirectory:f(""==g?"/":g),
filePath:f(l),fileName:f(k),fileDirectory:f(h),originalPath:a};JSON.stringify(a);return a}e.createTree=function(a,d,b,e,f,g,k){l(a,d,b,e,f,g,k,1E4)};e.createTreeOfDepth=l;e.isResourceFolder=p;e.cleanResourcePath=f;e.createResourcePath=n})(FileTree||(FileTree={}));ModuleSystem.registerModule("tree","Tree module: tree.js",null,["common"]);
