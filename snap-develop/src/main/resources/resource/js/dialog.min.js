...
function p(a,b){var c=q(a?escapeHtml(a):"");w2popup.open({title:b,body:c,buttons:'\x3cbutton id\x3d"dialogSave" class\x3d"btn dialogButton"\x3eEvaluate\x3c/button\x3e',width:700,height:400,overflow:"hidden",color:"#999",speed:"0.3",opacity:"0.8",modal:!1,showClose:!0,showMax:!0,onOpen:function(a){setTimeout(function(){$("#dialog").w2grid({recordTitles:!1,name:"evaluation",columns:[{field:"name",caption:"Name",size:"40%",sortable:!1},{field:"value",caption:"Value",size:"30%",sortable:!1},{field:"type",
...
b=b+d.style,b=b+"' onclick\x3d'return DialogBuilder.submitDialogListResource";d.line?(b+='("',b+=d.resource,b+='", ',b+=d.line,b+=")"):(b+='("',b+=d.link,b+='")');b+="'\x3e";b+=d.text;b+="\x3c/div\x3e\x3c/td\x3e"}b+="\x3ctd\x3e\x26nbsp;\x26nbsp;\x26nbsp;\x26nbsp;\x3c/td\x3e";b+="\x3c/tr\x3e"}return b+"\x3c/table\x3e"}function q(a){a||(a="");return'\x3cdiv id\x3d"dialogContainerBig"\x3e   \x3cdiv id\x3d"dialog"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"dialogPath" onkeydown\x3d"return DialogBuilder.submitDialog(event);" contenteditable\x3d"true" onclick\x3d"return DialogBuilder.focusDialogInput(\'dialogPath\');"\x3e'+
...
b,c,e,f){w2popup.open({title:c,body:'\x3cdiv id\x3d"dialogContainerBig"\x3e\n   \x3cdiv id\x3d"dialog"\x3e\x3c/div\x3e\n\x3c/div\x3e\n\x3cdiv id\x3d"dialogPath" onkeydown\x3d"return DialogBuilder.submitDialog(event);" contenteditable\x3d"true" onclick\x3d"return DialogBuilder.focusDialogInput(\'dialogPath\');"\x3e\x3c/div\x3e',buttons:'\x3cbutton id\x3d"dialogSave" class\x3d"btn dialogButton"\x3e'+e+"\x3c/button\x3e",width:500,height:400,overflow:"hidden",color:"#999",speed:"0.3",opacity:"0.8",modal:!0,
showClose:!0,showMax:!0,onOpen:function(a){setTimeout(function(){var a=document.getElementById("dialogPath");a.contentEditable=!0;a.focus()},200)},onClose:function(a){b()},onMax:function(a){console.log("max");$(window).trigger("resize")},onMin:function(a){console.log("min");$(window).trigger("resize")},onKeydown:function(a){console.log("keydown")}});$("#dialogSave").click(function(){var b=$("#dialogPath").html(),b=FileTree.cleanResourcePath(b),b=FileTree.createResourcePath(b),c=b.projectDirectory;
0==c.indexOf("/")&&(c=c.substring(1));a(b,c);w2popup.close()});FileTree.createTreeOfDepth(f,"dialog","dialogTree","/"+document.title,!0,null,function(a,b){var d=FileTree.createResourcePath(b.node.tooltip).projectDirectory;0==d.indexOf("/")&&(d=d.substring(1));$("#dialogPath").html(FileTree.cleanResourcePath(d))},2)};e.createListDialog=function(a,b,c){w2popup.open({title:c,body:'\x3cdiv id\x3d"dialogContainerBig"\x3e   \x3cdiv id\x3d"dialog"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"dialogPath" onkeydown\x3d"return DialogBuilder.submitDialog(event);" contenteditable\x3d"true" onclick\x3d"return DialogBuilder.focusDialogInput(\'dialogPath\');"\x3e\x3c/div\x3e',
