...
function(){0==r&&(window.setTimeout(k,500),r=!0);t.EventBus.createRoute("RELOAD_TREE",k)};p.openTreeFile=m;p.openTreeHistoryFile=function(a,b,d){var c=a.toLowerCase(),e=a.replace(/^\/resource/i,"/history");if(h.Common.stringEndsWith(c,".json")||h.Common.stringEndsWith(c,".js")){var f=e+"?time\x3d"+b;n.ajax({url:f,type:"get",dataType:"text",success:function(b,c,e){c=e.getResponseHeader("content-type");g(a,d,b,c,f)},error:function(b){g(a,d,"// Could not find "+c,"text/plain",f)},async:!1})}else f=e+
"?time\x3d"+b,n.ajax({url:f,type:"get",success:function(b,c,e){c=e.getResponseHeader("content-type");g(a,d,b,c,f)},error:function(b){g(a,d,"// Could not find "+c,"text/plain",f)},async:!1})}})(k.FileExplorer||(k.FileExplorer={}))});
