...
b?Command.exploreDirectory(a):"renameFile"==b?d?Command.renameDirectory(a):Command.renameFile(a):"saveFile"==b?f(a.resourcePath,function(){Command.saveFile()}):"deleteFile"==b&&(FileTree.isResourceFolder(a.resourcePath)?Command.deleteDirectory(a):Command.deleteFile(a))}var k=!1;g.showTree=function(){0==k&&(window.setTimeout(h,500),k=!0);createRoute("RELOAD_TREE",h)};g.openTreeFile=f;g.openTreeHistoryFile=function(a,b,c){var e=a.toLowerCase(),f=a.replace(/^\/resource/i,"/history");stringEndsWith(e,
".json")||stringEndsWith(e,".js"),jQuery.ajax({url:f+"?time\x3d"+b,type:"get",success:function(b){d(a,c,b)},error:function(b){d(a,c,"// Could not find "+e)},async:!1})}})(FileExplorer||(FileExplorer={}));ModuleSystem.registerModule("explorer","Explorer module: explorer.js",FileExplorer.showTree,["common","spinner","tree","commands"]);
