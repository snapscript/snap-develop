...
f)}}updateTableRecords(c,"debug")}var e={},d=null;g.createStatus=function(){EventBus.createRoute("STATUS",q,r);EventBus.createRoute("TERMINATE",l);EventBus.createRoute("EXIT",l);setInterval(p,1E3)};g.isCurrentStatusFocusRunning=function(){if(d){var c=e[statusProcess];if(c)return null!=c.resource}return!1};g.currentStatusFocus=function(){return d};g.showStatus=h})(DebugManager||(DebugManager={}));
